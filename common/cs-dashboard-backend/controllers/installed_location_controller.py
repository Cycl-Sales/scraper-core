        ...
        try:
            ...
            for message in call_messages:
                ...
                message_data = {
                    ...
                    'recording_available': message.recording_available if message.recording_checked else True,
                    'recording_checked': message.recording_checked,
                    'transcript_available': message.transcript_available if message.transcript_checked else True,
                    'transcript_checked': message.transcript_checked,
    ...
    def sync_location_contacts(self, **kwargs):
        ...
        try:
            ...
            def background_full_sync():
                ...
                for attempt in range(max_retries):
                    try:
                        _(f"Starting full GHL sync for location {location_id} (attempt {attempt + 1})")
